...
export default function Login() {
  ...
  // Check if user is already logged in (await async checks; ignore 401s)
  useEffect(() => {
    let mounted = true;
    (async () => {
      try {
        ...
        // ignore unauthenticated errors on login page
      }
    })();
  ...
  <div className="max-w-md w-full space-y-8">
    ...
    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="group relative w-full flex justify-center py-3 px-4 text-sm font-medium rounded-lg 
          ...
          hover:from-emerald-700 hover:to-teal-700 focus:outline-none 
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[#121110] text-gray-500">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <button
        type="button"
        onClick={handleGoogleLogin}
        className="w-full flex justify-center items-center px-4 py-3 border border-gray-700 rounded-lg shadow-sm bg-[#1a1a1a] text-sm font-medium text-gray-300 hover:bg-[#1e1e1e] focus:outline-none focus:ring-2 focus:ring-teal-500 transition"
      >
        <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
          <path 
            fill="#4285F4" 
    ...
    <div className="text-center">
      <p className="text-sm text-gray-400">
        ...
        <Link
          to="/register"
          className="font-medium text-teal-400 hover:text-teal-300 transition"
        >
          Sign up here
        </Link>
      </p>
