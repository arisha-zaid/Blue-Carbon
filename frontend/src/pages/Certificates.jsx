...
export default function Certificates() {
  ...
  <h2 className="text-3xl font-bold text-gray-100 mb-2">Carbon Certificates</h2>
  ...
  <div className="mt-6 grid md:grid-cols-2 gap-6">
    {projects.map((p) => (
      ...
      >
        {/* Verified Badge */}
        <div className="absolute top-4 right-4 flex items-center space-x-1 px-3 py-1 
        ...
        <div className="relative z-10 bg-[#121110] rounded-xl p-6 mt-6 border border-gray-700 shadow-inner">
          <div className="grid grid-cols-2 gap-y-4 gap-x-6 text-gray-300">
            <div>
              <div className="text-sm font-semibold text-gray-400">CO₂ Credits</div>
              <div className="text-xl font-bold text-emerald-500">{p.predictedCO2}</div>
            </div>
            <div>
              <div className="text-sm font-semibold text-gray-400">Issue Date</div>
              <div className="text-xl font-bold">
                {p.certificateAt
                  ? new Date(p.certificateAt).toLocaleDateString()
                  : "N/A"}
