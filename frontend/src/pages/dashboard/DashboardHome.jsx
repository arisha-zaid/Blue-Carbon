...
export default function DashboardHome() {
  ...
  return (
    ...
    <div className="space-y-8 md:ml-64 bg-[#121110] min-h-screen text-gray-200 p-8">
  {/* Hero */}
    ...
    <div className="p-6 md:p-8">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="bg-[#1a1a1a] border border-gray-700 rounded-2xl p-5 w-full max-w-md shadow-[0_0_8px_#2DD4BF]">
          <div className="font-semibold text-teal-400 mb-3">Quarter Progress</div>
          <div className="space-y-3">
...
<section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
  {kpis.map((k) => (
    ...
    >
      {/* Icon */}
      <div className={`w-10 h-10 flex items-center justify-center rounded-full ${k.color} bg-opacity-20`}>
        {k.icon}
      </div>
  ...
  <div className="bg-[#1a1a1a] rounded-2xl shadow-lg p-6 border border-gray-700">
    <div className="flex items-center justify-between mb-4">
      <h3 className="font-semibold text-teal-400 flex items-center gap-2">
        <LineIcon className="w-5 h-5 text-cyan-400" /> Annual CO₂ Gains (t)
      </h3>
    ...
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={carbonTrend}>
        ...
        <YAxis stroke="#888" />
        <Tooltip contentStyle={{ backgroundColor: "#1a1a1a", border: "1px solid #2DD4BF" }} />
        <Area type="monotone" dataKey="t" stroke="#10b981" fill="url(#g1)" />
      </AreaChart>
    </ResponsiveContainer>
  </div>
  ...
  <div className="bg-[#1a1a1a] rounded-2xl shadow-lg p-6 border border-gray-700">
    <div className="flex items-center justify-between mb-4">
      <h3 className="font-semibold text-teal-400">Estimated Revenue ($)</h3>
    ...
    <div className="bg-[#1a1a1a] rounded-2xl shadow-lg p-6 border border-gray-700">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="text-sm font-medium text-gray-200">Add Project</div>
          <div className="text-xs text-gray-400">Create a new registry entry</div>
        </Link>
        <Link
          to="/certificates"
        ...
        >
          ...
          <div className="text-sm font-medium text-gray-200">Certificates</div>
            ...
            >
              <td colSpan={5}>
                ...
                <div className="relative grid grid-cols-5 gap-4 py-3 px-4">
                  <div>
                    <Link to={`/project/${p.id}`} className="text-teal-400 underline">
                      {p.name}
                    </Link>
                    <div className="text-xs text-gray-500">{p.id}</div>
                  </div>
