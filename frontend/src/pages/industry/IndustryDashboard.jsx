...
//     <div
//       key={k.title}
//       className="rounded-2xl p-6 border border-gray-700 bg-[#1a1a1a] text-gray-200 transition-all duration-300"
//       style={{ transition: "all 0.3s ease" }}
//       onMouseEnter={(e) => {
//         e.currentTarget.style.boxShadow =
//           idx % 2 === 0 ? "0 0 12px #2DD4BF" : "0 0 12px #FACC15"; // cyan or golden glow
//         e.currentTarget.style.borderColor =
//           idx % 2 === 0 ? "#2DD4BF" : "#FACC15";
//       }}
//       onMouseLeave={(e) => {
//         e.currentTarget.style.boxShadow = "none";
//         e.currentTarget.style.borderColor = "#374151"; // gray-700 fallback
//       }}
//     >
//       {/* Header inside KPI card */}
//       <div className="flex items-center justify-between">
...
//   {/* Line Chart Card */}
//   <div
//     className="rounded-2xl p-6 lg:col-span-2 border border-gray-700 bg-[#1a1a1a] text-gray-200 transition-all duration-300"
//   >
//     <div className="flex items-center justify-between mb-4">
...
//       <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
//   {/* Wallet Snapshot */}
//   <div className="rounded-2xl p-6 border border-gray-700 bg-[#1a1a1a] text-gray-200 transition-all duration-300">
...
//   {/* Recent Transactions */}
//   <div className="rounded-2xl p-6 lg:col-span-2 border border-gray-700 bg-[#1a1a1a] text-gray-200 transition-all duration-300">
//     <div className="flex items-center justify-between mb-4">
//       <h3 className="font-semibold text-gray-100">Recent Transactions</h3>
//       <Link to="/industry/transactions" className="text-sm text-emerald-400 hover:underline">
//         See all
//       </Link>
//     </div>
...
//         <tbody>
//           {recentTx.map((t) => (
//             <tr key={t.id} className="border-t border-gray-700 hover:bg-[#222] transition">
